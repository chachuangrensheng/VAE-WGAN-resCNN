...
from models9 import VAE_GAN,Discriminator
# nvidia-smi -l 0.2
...
if __name__=='__main__':
    ...
    transform = transforms.Compose([
        transforms.Resize((128, 64)),  # 根据需要调整图像大小
    ...
    show_and_save("training3" ,make_grid((real_batch[0]*0.5+0.5).cpu(),8))
    # show_and_save("training3",real_batch[0][0])
    # 定义损失函数
    ...
    # 绘制损失曲线
    plot_loss(prior_loss_list, 'models4_2_prior_loss0.png')  # 先验损失误差
    plot_loss(recon_loss_list, 'models4_2_recon_loss0.png')  # 重建损失误差
    plot_loss(gan_loss_list, 'models4_2_gan_loss0.png')   # GAN损失误差
