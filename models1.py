...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 64, 3, padding=2, stride=2)  # in_channels=3
        self.bn1 = nn.BatchNorm2d(64, momentum=0.9)
        self.conv2 = nn.Conv2d(64, 128, 3, padding=2, stride=2)
        self.bn2 = nn.BatchNorm2d(128, momentum=0.9)
        self.conv3 = nn.Conv2d(128, 256, 3, padding=2, stride=2)
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.relu = nn.LeakyReLU(0.2)
        self.deconv1 = nn.ConvTranspose2d(256, 256, 3, stride=2, padding=2)
        self.bn2 = nn.BatchNorm2d(256, momentum=0.9)
        self.deconv2 = nn.ConvTranspose2d(256, 128, 3, stride=2, padding=2)
        self.bn3 = nn.BatchNorm2d(128, momentum=0.9)
        self.deconv3 = nn.ConvTranspose2d(128, 32, 3, stride=2, padding=2)
...
class Discriminator(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 32, 3, padding=2, stride=1)
        self.relu = nn.LeakyReLU(0.2)
        self.conv2 = nn.Conv2d(32, 128, 3, padding=2, stride=2)
        self.bn1 = nn.BatchNorm2d(128, momentum=0.9)
        self.conv3 = nn.Conv2d(128, 256, 3, padding=2, stride=2)
        self.bn2 = nn.BatchNorm2d(256, momentum=0.9)
        self.conv4 = nn.Conv2d(256, 256, 3, padding=2, stride=2)
        self.bn3 = nn.BatchNorm2d(256, momentum=0.9)
